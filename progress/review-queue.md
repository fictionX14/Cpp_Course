...
| RAII (acquire/release, dtor-on-unwind) | 2026-07-16 | 3d | 2026-07-19 | Day 8: ctor/dtor pairing correct (fopen/fclose) but omitted the "guarantee" piece (stack-resident object) until prompted — held interval flat rather than growing further |
...
| Dangling pointer: heap-lifetime flavor (use-after-free via delete) | 2026-07-16 | 3d | 2026-07-19 | GAP CLOSED Day 8 — real use-after-free written, compiled under AddressSanitizer, report read precisely (alloc/free/bad-read lines) |
| UB's "silently appears to work" danger (vs. "always crashes") | 2026-07-14 | 3d | 2026-07-17 | nailed cleanly Day 6 — interval grows |
| `std::weak_ptr` (reference cycles, `.lock()` vs `use_count()`) | 2026-07-16 | 3d | 2026-07-19 | Day 8: cycle fix coded, compiled, and verified for real; self-caught a `.lock()`-as-assignment bug; correctly traced destructor cascade order |
